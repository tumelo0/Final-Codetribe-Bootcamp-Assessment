...
document.addEventListener('DOMContentLoaded', function() {
  const arrowContainer = document.querySelector('.nav__parent');
  const arrowIcon = document.querySelector('.nav__arrow');
...
document.addEventListener('DOMContentLoaded', function() {
  const arrowContainer = document.querySelector('.nav__parents');
  const arrowIcon = document.querySelector('.nav__arrows');
